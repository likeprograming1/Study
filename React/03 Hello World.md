...
> 
> 
> 이 안내서는 **개념들을 단계적으로** 배우길 원하는 사람들을 대상으로 합니다. 실습을 통해 배우길 원한다면, [실전 튜토리얼](https://ko.legacy.reactjs.org/tutorial/tutorial.html)을 확인하세요. 이 안내서와 실전 튜토리얼은 상호보완적인 내용을 담고 있습니다.
> 
...
이 안내서의 모든 장들은 이전 장의 내용을 토대로 작성되었습니다. **사이드바에 보이는 순서대로 “주요 개념” 안내서의 장들을 읽으면 React의 거의 모든 내용을 익힐 수 있습니다.** [“JSX 소개”](https://ko.legacy.reactjs.org/docs/introducing-jsx.html)가 바로 이 다음 장입니다.
...
아래로 계속 스크롤하면, 푸터 바로 앞에서 [다음 장](https://ko.legacy.reactjs.org/docs/introducing-jsx.html)으로 연결된 링크를 찾을 수 있습니다.
